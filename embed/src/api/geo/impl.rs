...
use crate::{
  api::{
    geo::{
      codec::{
        GEO_STEP_MAX, align_52bits, bounding_box, encode_geohash_string, geohash_decode_wgs84,
        geohash_encode_wgs84, get_areas_by_shape_wgs84, haversine_distance, scores_of_geohash_box,
        validate_long_lat,
      },
      opt::{
...
/// 地理空间索引接口 (GEO)
fn search_shape_internal<E: Engine, K: AsRef<[u8]>>(
  db: &Db<E>,
  key: K,
