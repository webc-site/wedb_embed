...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@2a/nAeWKUwUY6xj-tEmfRZA.svg" alt="wedb_embed vs Redis Performance & Resource Comparison" width="100%">
  <br>
...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@TF/PxOFV4PIJuAxVL2i7EWg.svg" alt="wedb_embed vs Redis 性能与资源对比" width="100%">
  <br>
...
| **实际物理落盘大小** | **1053 MB** | **7710 MB** | **节省 86%** |
| **进程常驻内存 (RSS)** | **290 MB** | **4832 MB** | **节省 94%** |
