...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@_s/P8iRInUMvfnYwyAEG28w.svg" alt="wedb_embed vs Redis Performance & Resource Comparison" width="100%">
  <br>
...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@yX/0pGda15HrZcelttTdbBA.svg" alt="wedb_embed vs Redis 性能与资源对比" width="100%">
  <br>
...
| **实际物理落盘大小** | **1053 MB** | **7425 MB** | **节省 86%** |
| **进程常驻内存 (RSS)** | **288 MB** | **4844 MB** | **节省 94%** |
