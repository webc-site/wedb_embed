...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@4M/hdeDnQnofNWiktwCoKvw.svg" alt="wedb_embed vs Redis Performance & Resource Comparison" width="100%">
  <br>
...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@FM/mr9hpV5QuhURDiEI5u3A.svg" alt="wedb_embed vs Redis 性能与资源对比" width="100%">
  <br>
...
| **实际物理落盘大小** | **1053 MB** | **7567 MB** | **节省 86%** |
| **进程常驻内存 (RSS)** | **271 MB** | **4802 MB** | **节省 94%** |
