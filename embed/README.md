...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@l-/M-4J7jTjzAxjyN2Xzqqw.svg" alt="wedb_embed vs Redis Performance & Resource Comparison" width="100%">
  <br>
...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@NR/vOIftif6WuVrEjBbg-yg.svg" alt="wedb_embed vs Redis 性能与资源对比" width="100%">
  <br>
...
| **实际物理落盘大小** | **1053 MB** | **7676 MB** | **节省 86%** |
| **进程常驻内存 (RSS)** | **281 MB** | **4817 MB** | **节省 94%** |
