...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@w0/WJh2O4CM7Lq3xL0WxA4w.svg" alt="wedb_embed vs Redis Performance & Resource Comparison" width="100%">
  <br>
  <sub><b>Benchmark Environment</b>: CPU: AMD EPYC 9V74 80-Core Processor (4 cores) ｜ Memory: 15.6 GB ｜ Disk: Azure Managed Virtual Disk (Cloud Standard SSD) ｜ OS: Ubuntu 24.04.4 LTS (Linux 6.17.0-1022-azure) ｜ Rust: 1.98.0 (88d9e12ae 2026-08-18) ｜ Redis: v8.10.1</sub>
</p>
...
| **Physical Disk Footprint** | **1053 MB** | **7556 MB** | **Saves 86%** |
| **Resident Memory (RSS)** | **284 MB** | **4818 MB** | **Saves 94%** |
...
<p align="center">
  <img src="https://fastly.jsdelivr.net/gh/webc-fs/-@bU/Al7agPvgXUKZpVBJChRQ.svg" alt="wedb_embed vs Redis 性能与资源对比" width="100%">
  <br>
